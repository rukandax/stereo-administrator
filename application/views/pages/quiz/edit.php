...
<div class="card shadow mb-4">
  <div class="card-body">
    <form method="post" action="<?= base_url('/quiz/update/' . $data['quiz'][0]['id']) ?>">
      <div class="form-group">
        <label for="name">Name</label>
        <input required type="text" class="form-control" value="<?= $data['quiz'][0]['name'] ?>" autocomplete="off" id="name" name="name">
      </div>
      <div class="form-group">
        <label for="nip">NIP</label>
        <input required type="text" class="form-control" value="<?= $data['quiz'][0]['nip'] ?>" autocomplete="off" id="nip" name="nip">
      </div>
      <div class="form-group">
