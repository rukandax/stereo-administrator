...
<div class="card shadow mb-4">
  <div class="card-body">
    <form method="post" action="<?= base_url('/division/update/' . $data['division'][0]['id']) ?>">
      <div class="form-group">
        <label for="name">Division Name</label>
        <input required type="text" class="form-control" autocomplete="off" value="<?= $data['division'][0]['name'] ?>" id="name" name="name">
      </div>
